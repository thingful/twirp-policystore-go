...
/*
Package policystore is a generated twirp stub package.
...
// ===========================
// PolicyStore Protobuf Client
// ===========================

type policyStoreProtobufClient struct {
	client HTTPClient
	urls   [3]string
}

// NewPolicyStoreProtobufClient creates a Protobuf client that implements the PolicyStore interface.
// It communicates using Protobuf and can be configured with a custom HTTPClient.
func NewPolicyStoreProtobufClient(addr string, client HTTPClient) PolicyStore {
	prefix := urlBase(addr) + PolicyStorePathPrefix
	urls := [3]string{
	...
	if httpClient, ok := client.(*http.Client); ok {
		return &policyStoreProtobufClient{
...
func (c *policyStoreProtobufClient) CreateEntitlementPolicy(ctx context.Context, in *CreateEntitlementPolicyRequest) (*CreateEntitlementPolicyResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "decode.iot.policystore")
	ctx = ctxsetters.WithServiceName(ctx, "PolicyStore")
...
func (c *policyStoreProtobufClient) DeleteEntitlementPolicy(ctx context.Context, in *DeleteEntitlementPolicyRequest) (*DeleteEntitlementPolicyResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "decode.iot.policystore")
	ctx = ctxsetters.WithServiceName(ctx, "PolicyStore")
...
func (c *policyStoreProtobufClient) ListEntitlementPolicies(ctx context.Context, in *ListEntitlementPoliciesRequest) (*ListEntitlementPoliciesResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "decode.iot.policystore")
	ctx = ctxsetters.WithServiceName(ctx, "PolicyStore")
...
// =======================
// PolicyStore JSON Client
// =======================

type policyStoreJSONClient struct {
	client HTTPClient
	urls   [3]string
}

// NewPolicyStoreJSONClient creates a JSON client that implements the PolicyStore interface.
...
func (c *policyStoreJSONClient) CreateEntitlementPolicy(ctx context.Context, in *CreateEntitlementPolicyRequest) (*CreateEntitlementPolicyResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "decode.iot.policystore")
	ctx = ctxsetters.WithServiceName(ctx, "PolicyStore")
	ctx = ctxsetters.WithMethodName(ctx, "CreateEntitlementPolicy")
	out := new(CreateEntitlementPolicyResponse)
...
func (c *policyStoreJSONClient) DeleteEntitlementPolicy(ctx context.Context, in *DeleteEntitlementPolicyRequest) (*DeleteEntitlementPolicyResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "decode.iot.policystore")
	ctx = ctxsetters.WithServiceName(ctx, "PolicyStore")
	ctx = ctxsetters.WithMethodName(ctx, "DeleteEntitlementPolicy")
	out := new(DeleteEntitlementPolicyResponse)
...
func (c *policyStoreJSONClient) ListEntitlementPolicies(ctx context.Context, in *ListEntitlementPoliciesRequest) (*ListEntitlementPoliciesResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "decode.iot.policystore")
	ctx = ctxsetters.WithServiceName(ctx, "PolicyStore")
	ctx = ctxsetters.WithMethodName(ctx, "ListEntitlementPolicies")
	out := new(ListEntitlementPoliciesResponse)
...
func (s *policyStoreServer) writeError(ctx context.Context, resp http.ResponseWriter, err error) {
	writeError(ctx, resp, err, s.hooks)
}

// PolicyStorePathPrefix is used for all URL paths on a twirp PolicyStore server.
// Requests are always: POST PolicyStorePathPrefix/method
// It can be used in an HTTP mux to route twirp requests along with non-twirp requests on other routes.
const PolicyStorePathPrefix = "/twirp/decode.iot.policystore.PolicyStore/"

func (s *policyStoreServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	ctx := req.Context()
	ctx = ctxsetters.WithPackageName(ctx, "decode.iot.policystore")
	ctx = ctxsetters.WithServiceName(ctx, "PolicyStore")
	...
	switch req.URL.Path {
	case "/twirp/decode.iot.policystore.PolicyStore/CreateEntitlementPolicy":
		s.serveCreateEntitlementPolicy(ctx, resp, req)
		return
	case "/twirp/decode.iot.policystore.PolicyStore/DeleteEntitlementPolicy":
		s.serveDeleteEntitlementPolicy(ctx, resp, req)
		return
	case "/twirp/decode.iot.policystore.PolicyStore/ListEntitlementPolicies":
...
func (s *policyStoreServer) serveCreateEntitlementPolicy(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
...
func (s *policyStoreServer) serveCreateEntitlementPolicyJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "CreateEntitlementPolicy")
	...
	func() {
		...
		respContent, err = s.PolicyStore.CreateEntitlementPolicy(ctx, reqContent)
	}()
...
func (s *policyStoreServer) serveCreateEntitlementPolicyProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "CreateEntitlementPolicy")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *policyStoreServer) serveDeleteEntitlementPolicy(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
...
func (s *policyStoreServer) serveDeleteEntitlementPolicyJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "DeleteEntitlementPolicy")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	func() {
		...
		respContent, err = s.PolicyStore.DeleteEntitlementPolicy(ctx, reqContent)
	}()
...
func (s *policyStoreServer) serveDeleteEntitlementPolicyProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "DeleteEntitlementPolicy")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *policyStoreServer) serveListEntitlementPolicies(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
...
func (s *policyStoreServer) serveListEntitlementPoliciesJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "ListEntitlementPolicies")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	func() {
		...
		respContent, err = s.PolicyStore.ListEntitlementPolicies(ctx, reqContent)
	}()
...
func (s *policyStoreServer) serveListEntitlementPoliciesProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "ListEntitlementPolicies")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *policyStoreServer) ServiceDescriptor() ([]byte, int) {
	return twirpFileDescriptor0, 0
}

func (s *policyStoreServer) ProtocGenTwirpVersion() string {
	return "v5.4.2"
}
